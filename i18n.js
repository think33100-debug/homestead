...
var I18N = {
  ko: {
    ...
    mTipT:'꼭 읽어주세요 · 이용 Tip', mTipD:'도어락 · 세탁실 · 어메니티 · 맛집',
    ...
    lateForm:'보관 신청하기', lateRoom:'이용하셨던 객실', lateName:'성함', latePhone:'연락처', latePickup:'찾아가실 시간',
  ...
  en: {
    ...
    mTipT:'Must Read · Stay Tips', mTipD:'Door lock · laundry · amenities · restaurants',
    ...
    lateForm:'Request storage', lateRoom:'Room you stayed in', lateName:'Name', latePhone:'Phone number', latePickup:'Pick-up time',
  ...
  ja: {
    ...
    mTipT:'必読 · ご利用のヒント', mTipD:'ドアロック・洗濯室・アメニティ・グルメ',
    ...
    lateForm:'預かりを申請する', lateRoom:'ご利用いただいたお部屋', lateName:'お名前', latePhone:'ご連絡先', latePickup:'お引き取り予定時刻',
  ...
  zh: {
    ...
    mTipT:'必读 · 住宿小贴士', mTipD:'门锁 · 洗衣房 · 备品 · 美食',
    ...
    lateForm:'申请寄存', lateRoom:'您入住过的房间', lateName:'姓名', latePhone:'联系电话', latePickup:'预计取回时间',
