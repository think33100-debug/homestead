...
var I18N = {
  ko: {
    ...
    lateWarn:'⚠️ <b>꼭 확인해 주세요</b><br>· 귀중품은 보관이 어려우니 꼭 소지해 주세요<br>· 당일 오후 6시 이후에는 보관이 어렵습니다<br>· 보관 시 분실 책임을 지지 않으며, 30일 뒤 폐기됩니다',
  ...
  en: {
    ...
    lateWarn:'⚠️ <b>Please note</b><br>· Valuables cannot be stored — please keep them with you<br>· Storage is not available after 6 PM on the same day<br>· We cannot take responsibility for loss, and items are disposed of after 30 days',
  ...
  ja: {
    ...
    lateWarn:'⚠️ <b>必ずご確認ください</b><br>· 貴重品はお預かりできません。必ずお持ちください<br>· 当日午後6時以降のお預かりはできません<br>· 紛失の責任は負いかねます。30日後に処分いたします',
